...
public class SudokuGenerationService {
  ...
  private static final List<Pair> CELL_OFFSETS = List.of(
      Pair.of(0, 0), Pair.of(0, 1), Pair.of(0, 2),
      Pair.of(1, 0), Pair.of(1, 1), Pair.of(1, 2),
      Pair.of(2, 0), Pair.of(2, 1), Pair.of(2, 2));

  private static final List<Pair> CELL_POSITIONS = new ArrayList<>(List.of(
          Pair.of(0, 0), Pair.of(0, 1), Pair.of(0, 2), Pair.of(0, 3), Pair.of(0, 4), Pair.of(0, 5), Pair.of(0, 6), Pair.of(0, 7), Pair.of(0, 8),
          Pair.of(1, 0), Pair.of(1, 1), Pair.of(1, 2), Pair.of(1, 3), Pair.of(1, 4), Pair.of(1, 5), Pair.of(1, 6), Pair.of(1, 7), Pair.of(1, 8),
          Pair.of(2, 0), Pair.of(2, 1), Pair.of(2, 2), Pair.of(2, 3), Pair.of(2, 4), Pair.of(2, 5), Pair.of(2, 6), Pair.of(2, 7), Pair.of(2, 8),
          Pair.of(3, 0), Pair.of(3, 1), Pair.of(3, 2), Pair.of(3, 3), Pair.of(3, 4), Pair.of(3, 5), Pair.of(3, 6), Pair.of(3, 7), Pair.of(3, 8),
          Pair.of(4, 0), Pair.of(4, 1), Pair.of(4, 2), Pair.of(4, 3), Pair.of(4, 4), Pair.of(4, 5), Pair.of(4, 6), Pair.of(4, 7), Pair.of(4, 8),
          Pair.of(5, 0), Pair.of(5, 1), Pair.of(5, 2), Pair.of(5, 3), Pair.of(5, 4), Pair.of(5, 5), Pair.of(5, 6), Pair.of(5, 7), Pair.of(5, 8),
          Pair.of(6, 0), Pair.of(6, 1), Pair.of(6, 2), Pair.of(6, 3), Pair.of(6, 4), Pair.of(6, 5), Pair.of(6, 6), Pair.of(6, 7), Pair.of(6, 8),
          Pair.of(7, 0), Pair.of(7, 1), Pair.of(7, 2), Pair.of(7, 3), Pair.of(7, 4), Pair.of(7, 5), Pair.of(7, 6), Pair.of(7, 7), Pair.of(7, 8),
          Pair.of(8, 0), Pair.of(8, 1), Pair.of(8, 2), Pair.of(8, 3), Pair.of(8, 4), Pair.of(8, 5), Pair.of(8, 6), Pair.of(8, 7), Pair.of(8, 8)));
  ...
  /**
   * Removes digits from the Sudoku grid based on the specified difficulty level.
   * Very basic implementation that does not yet take the difficulty into account, but only removes a fixed number of cells.
